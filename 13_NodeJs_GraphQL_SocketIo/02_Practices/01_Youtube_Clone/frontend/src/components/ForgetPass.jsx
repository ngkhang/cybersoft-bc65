...
const ForgetPass = () => {
  ...
  const handleCheckMail = () => {
    ...
    forgetCheckCodeAPI({ email })
      .then((result) => setStep(1))
    ...
    <div className=" d-flex justify-content-center">
      ...
      {step === 0 && <form className="row g-3 text-white">
        ...
        <div className="col-12">
          <button type="button" className="btn btn-primary" onClick={handleCheckMail} >
            Next
          </button>
        </div>
      ...
      {step === 1 && <form className="row g-3 text-white">
        ...
        <div className="col-12">
          <button type="button" className="btn btn-primary" onClick={handleCheckCode} >
            Next
          </button>
        </div>
